...
nodeSize() -> Integer ; edgeSize() -> Integer ; getMC() -> Integer - Counter for Graph Modifications</p>
<p>
...
Also save\load weighted_graph is possile save(File Name) ; load(File Name) -> Both Methods return boolean value for sucsses or not.
